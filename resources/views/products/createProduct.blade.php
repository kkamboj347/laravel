            ...
            <form enctype="multipart/form-data" action ="{{ route('products.store') }}" method="post">
              ...
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <input value="{{ old('sku') }}" type="text" class="@error('sku') is-invalid @enderror form-control form-cotrol-lg" placeholder="Enter Sku" name="sku">
                  @error('sku')
                    <p class="invalid-feedback">{{ $message }}</p>
                  @enderror
                </div>
              ...
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <textarea value="{{ old('description') }}"class="@error('description') is-invalid  @enderror form-control form-control-lg" cols="30" rows="5" placeholder="Enter Description" name="description"></textarea>
                  @error('description')
                    <p class="invalid-feedback">{{ $message }}</p>
                  @enderror
                </div>
